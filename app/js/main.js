...
var APP_ID = 'xBtUzYLPkoZlkgTubmjU80fvAvshhOcZ7t5EohrB';
var APP_KEY = 'BmdXmJ2goqIWTRe1WjrRm8fMw9L7d5NahJ96tZac';
...
var contactBlock = (0, _jquery2['default'])('.contact-screen');
var topBlock = (0, _jquery2['default'])('.top-block');
var listBlock = (0, _jquery2['default'])('.list-block');

var router = new _router2['default'](contactBlock);
router.start();
...
var _viewsAddress_book = require('./views/address_book');

var _viewsAddress_book2 = _interopRequireDefault(_viewsAddress_book);

var _viewsContact_card = require('./views/contact_card');

var _viewsContact_card2 = _interopRequireDefault(_viewsContact_card);
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(contactBlock) {
  ...
  showAddressBook: function showAddressBook() {
    ...
    this.contacts.fetch().then(function () {
      router.$el.html((0, _viewsAddress_book2['default'])(router.contacts.toJSON()));
    });
  },
...
},{"./contacts_collection":3,"./views/address_book":6,"./views/contact_card":7,"./views/home":8,"backbone":9,"jquery":10}],6:[function(require,module,exports){
'use strict';
